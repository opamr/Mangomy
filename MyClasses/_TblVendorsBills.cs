...
namespace MyPro
{
	public abstract class _TblVendorsBills : SqlClientEntity
	{
		public _TblVendorsBills()
		{
			this.QuerySource = "TblVendorsBills";
			this.MappingName = "TblVendorsBills";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TblVendorsBillsLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int Bill_ID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TblVendorsBillsLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[Bill_ID] = _TblVendorsBills.PropertyNames.Bill_ID;
					ht[Bill_Date] = _TblVendorsBills.PropertyNames.Bill_Date;
					ht[Bill_VendorId] = _TblVendorsBills.PropertyNames.Bill_VendorId;
					ht[Bill_PayType] = _TblVendorsBills.PropertyNames.Bill_PayType;
					ht[Bill_Sender] = _TblVendorsBills.PropertyNames.Bill_Sender;
					ht[Bill_Details] = _TblVendorsBills.PropertyNames.Bill_Details;
					ht[Bill_DiscountType] = _TblVendorsBills.PropertyNames.Bill_DiscountType;
					ht[Bill_Discount] = _TblVendorsBills.PropertyNames.Bill_Discount;
					ht[Bill_Discount_Money] = _TblVendorsBills.PropertyNames.Bill_Discount_Money;
					ht[Store_Id] = _TblVendorsBills.PropertyNames.Store_Id;
					ht[User_Id] = _TblVendorsBills.PropertyNames.User_Id;
					ht[Bank_Id] = _TblVendorsBills.PropertyNames.Bank_Id;
					ht[Bill_Vat] = _TblVendorsBills.PropertyNames.Bill_Vat;
					ht[Bill_VendorNumber] = _TblVendorsBills.PropertyNames.Bill_VendorNumber;
					ht[Bill_Vat_Value] = _TblVendorsBills.PropertyNames.Bill_Vat_Value;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[Bill_ID] = _TblVendorsBills.ColumnNames.Bill_ID;
					ht[Bill_Date] = _TblVendorsBills.ColumnNames.Bill_Date;
					ht[Bill_VendorId] = _TblVendorsBills.ColumnNames.Bill_VendorId;
					ht[Bill_PayType] = _TblVendorsBills.ColumnNames.Bill_PayType;
					ht[Bill_Sender] = _TblVendorsBills.ColumnNames.Bill_Sender;
					ht[Bill_Details] = _TblVendorsBills.ColumnNames.Bill_Details;
					ht[Bill_DiscountType] = _TblVendorsBills.ColumnNames.Bill_DiscountType;
					ht[Bill_Discount] = _TblVendorsBills.ColumnNames.Bill_Discount;
					ht[Bill_Discount_Money] = _TblVendorsBills.ColumnNames.Bill_Discount_Money;
					ht[Store_Id] = _TblVendorsBills.ColumnNames.Store_Id;
					ht[User_Id] = _TblVendorsBills.ColumnNames.User_Id;
					ht[Bank_Id] = _TblVendorsBills.ColumnNames.Bank_Id;
					ht[Bill_Vat] = _TblVendorsBills.ColumnNames.Bill_Vat;
					ht[Bill_VendorNumber] = _TblVendorsBills.ColumnNames.Bill_VendorNumber;
					ht[Bill_Vat_Value] = _TblVendorsBills.ColumnNames.Bill_Vat_Value;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TblVendorsBillsInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.Bill_ID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TblVendorsBillsUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TblVendorsBillsDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.Bill_VendorId);
			p.SourceColumn = ColumnNames.Bill_VendorId;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.Bill_PayType);
			p.SourceColumn = ColumnNames.Bill_PayType;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.Bill_Sender);
			p.SourceColumn = ColumnNames.Bill_Sender;
			p.SourceVersion = DataRowVersion.Current;
			...
			p = cmd.Parameters.Add(Parameters.Bill_Discount_Money);
			p.SourceColumn = ColumnNames.Bill_Discount_Money;
			p.SourceVersion = DataRowVersion.Current;
			...
			p = cmd.Parameters.Add(Parameters.Bill_VendorNumber);
			p.SourceColumn = ColumnNames.Bill_VendorNumber;
			p.SourceVersion = DataRowVersion.Current;

...
namespace MyPro
{
	public abstract class _TblStoreReviewSummary : SqlClientEntity
	{
		public _TblStoreReviewSummary()
		{
			this.QuerySource = "TblStoreReviewSummary";
			this.MappingName = "TblStoreReviewSummary";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TblStoreReviewSummaryLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int Summary_ID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.Summary_ID, Summary_ID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_TblStoreReviewSummaryLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[Summary_ID] = _TblStoreReviewSummary.PropertyNames.Summary_ID;
					ht[Review_Id] = _TblStoreReviewSummary.PropertyNames.Review_Id;
					ht[Title_Id] = _TblStoreReviewSummary.PropertyNames.Title_Id;
					ht[Program_Count] = _TblStoreReviewSummary.PropertyNames.Program_Count;
					ht[Entry_Count] = _TblStoreReviewSummary.PropertyNames.Entry_Count;
					ht[Detail_Type] = _TblStoreReviewSummary.PropertyNames.Detail_Type;
					ht[Detail_Difference] = _TblStoreReviewSummary.PropertyNames.Detail_Difference;
					ht[Pay_Price] = _TblStoreReviewSummary.PropertyNames.Pay_Price;
					ht[Detail_Total] = _TblStoreReviewSummary.PropertyNames.Detail_Total;
					ht[User_Id] = _TblStoreReviewSummary.PropertyNames.User_Id;
					ht[Detail_TotalGood] = _TblStoreReviewSummary.PropertyNames.Detail_TotalGood;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[Summary_ID] = _TblStoreReviewSummary.ColumnNames.Summary_ID;
					ht[Review_Id] = _TblStoreReviewSummary.ColumnNames.Review_Id;
					ht[Title_Id] = _TblStoreReviewSummary.ColumnNames.Title_Id;
					ht[Program_Count] = _TblStoreReviewSummary.ColumnNames.Program_Count;
					ht[Entry_Count] = _TblStoreReviewSummary.ColumnNames.Entry_Count;
					ht[Detail_Type] = _TblStoreReviewSummary.ColumnNames.Detail_Type;
					ht[Detail_Difference] = _TblStoreReviewSummary.ColumnNames.Detail_Difference;
					ht[Pay_Price] = _TblStoreReviewSummary.ColumnNames.Pay_Price;
					ht[Detail_Total] = _TblStoreReviewSummary.ColumnNames.Detail_Total;
					ht[User_Id] = _TblStoreReviewSummary.ColumnNames.User_Id;
					ht[Detail_TotalGood] = _TblStoreReviewSummary.ColumnNames.Detail_TotalGood;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TblStoreReviewSummaryInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.Summary_ID.ParameterName];
			p.Direction = ParameterDirection.Output;
			p = cmd.Parameters[Parameters.Detail_Total.ParameterName];
			p.Direction = ParameterDirection.Output;
			p = cmd.Parameters[Parameters.Detail_TotalGood.ParameterName];
			p.Direction = ParameterDirection.Output;
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TblStoreReviewSummaryUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_TblStoreReviewSummaryDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.Program_Count);
			p.SourceColumn = ColumnNames.Program_Count;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.Entry_Count);
			p.SourceColumn = ColumnNames.Entry_Count;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.Detail_Type);
			p.SourceColumn = ColumnNames.Detail_Type;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.Detail_Difference);
			p.SourceColumn = ColumnNames.Detail_Difference;
			p.SourceVersion = DataRowVersion.Current;
			...
			p = cmd.Parameters.Add(Parameters.Detail_Total);
			p.SourceColumn = ColumnNames.Detail_Total;
			p.SourceVersion = DataRowVersion.Current;
			...
			p = cmd.Parameters.Add(Parameters.Detail_TotalGood);
			p.SourceColumn = ColumnNames.Detail_TotalGood;
			p.SourceVersion = DataRowVersion.Current;
